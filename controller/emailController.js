...
<p>Read the full message: <a href="webmail.tophoneys.com">open email client</a></p>
`
  ...
  let info = await transporter.sendMail({
    ...
    subject: `Contact form email from: ${senderName}`,
    text: txt,
    html: output,
  })
  // send confirmation email
  await transporter.sendMail({
    from: "TOP HONEYS<info@tophoneys.pl>",
  ...
  await transporter.sendMail({
    from: "TOP HONEYS<info@tophoneys.pl>",
    to: `dabrowskigrzegorz0@gmail.com`,
